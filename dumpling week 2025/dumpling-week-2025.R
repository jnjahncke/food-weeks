...
url <- 'https://www.dumpling-week.com/'
webpage <- read_html(url)

# get restaurant and dumpling names
restaurants <- html_nodes(webpage, '.list-item-content__title') |> html_text2()
img_links <- html_elements(webpage, '.list-image') |> html_attr("src")
